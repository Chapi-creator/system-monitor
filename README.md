...
cd dist
WEBVIEW2_ADDITIONAL_BROWSER_ARGUMENTS="--remote-debugging-port=9223" "./System Monitor Widget-Tauri-Portable-1.1.1.exe" &  # desde dist/
...
- Close the test instance afterwards (`Get-Process 'System Monitor Widget-Tauri-Portable-1.1.1' | Stop-Process`) so it doesn't fight the single-instance lock with your daily session.
